                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input type="text" name="name" placeholder="Enter your name please"
                               class="input" autocomplete="name" value="{{ old('name', $bar) }}" autofocus>
                    </div>
                    @error('name')
                    <span>
                <i></i>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input type="text" name="grault" placeholder="Enter a waldo"
                               class="input" autocomplete="grault" value="{{ old('grault', $bar) }}" autofocus>
                    </div>
                    @error('grault')
                    <span>
                <i></i>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input type="text" name="waldo" placeholder="Enter a waldo please"
                               class="input" autocomplete="waldo" value="{{ old('waldo', $bar) }}" autofocus>
                    </div>
                    @error('waldo')
                    <span>
                <i></i>
